...
<body>
    <div class="nav">
        <div class="logo">
            <p><a href="home.php"> Ritter Sport Chocolate</a></p>
        </div>
    ...
    <div class="container">
        <div class="box form-box">
            <?php 
              ...
              echo "<a href='home.php'><button class='btn'>Домой</button>";
            ...
            <form action="" method="post">
                ...
                <div class="field">
                    ...
                    <input type="submit" class="btn" name="submit" value="Обновить данные" required>
                </div>
